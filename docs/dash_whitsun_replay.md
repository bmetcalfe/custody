...
| Context map                        | Lightweight placeholder context block: AOI center, AOI fixture path, candidate tracks present at the selected step, and the relevant custody snapshot (status / score). |
