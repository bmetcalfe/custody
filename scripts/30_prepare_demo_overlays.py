...
_NON_UMBRA_OVERLAYS: list[dict[str, Any]] = [
    ...
    # ---- In-between Whitsun Sentinel coverage records ------------------
    # These 4 additional overlays mirror the expanded Sentinel
    # observation fixture (data/demo/whitsun_sentinel_observations.fixture.json)
    # and answer "what public observations covered the Whitsun interest
    # zone between Umbra collects?".  They default to off so they don't
    # crowd the map; the operator opts in via the per-overlay toggle.
    {
        "overlay_id": "whitsun-sentinel-1-grd-20231204",
        "scenario_id": "whitsun",
        "observation_id": "fixture-s1-grd-whitsun-20231204",
        "source": "sentinel-1",
        "sensor_type": "sar",
        "display_name": "Sentinel-1 GRD 2023-12-04 (ascending)",
        "data_mode": "fixture",
        "image_path": None,
        "asset_url": None,
        "image_kind": "footprint-only",
        ...
        "caveats": [
            "weak-signal cueing layer; not high-confidence proof",
            "in-between coverage record (pre-Umbra context)",
        ],
        "missing_asset_reason": (
            "no committed Sentinel-1 GRD raster; footprint-only"
        ),
        "collection_time": "2023-12-04",
        "default_visible": False,
        "resolution_m": 10.0,
        "cloud_coverage": None,
        "weak_signal": True,
    ...
    {
        "overlay_id": "whitsun-sentinel-2-mid-cloud-20231207",
        "scenario_id": "whitsun",
        "observation_id": "fixture-s2-l2a-whitsun-20231207-mid-cloud",
        "source": "sentinel-2",
        "sensor_type": "optical",
        "display_name": "Sentinel-2 L2A 2023-12-07 (45% cloud)",
        "data_mode": "fixture",
        "image_path": None,
        "asset_url": None,
        "image_kind": "footprint-only",
        ...
        "caveats": [
            "weak-signal cueing layer; not high-confidence proof",
            "mid-cloud Sentinel-2; usable for context only, not detection",
            "in-between coverage record",
        ],
        "missing_asset_reason": (
            "no committed Sentinel-2 RGB preview; footprint-only"
        ),
        "collection_time": "2023-12-07",
        "default_visible": False,
        "resolution_m": None,
        "cloud_coverage": 45,
        "weak_signal": True,
    ...
    {
        "overlay_id": "whitsun-sentinel-1-grd-20231209",
        "scenario_id": "whitsun",
        "observation_id": "fixture-s1-grd-whitsun-20231209",
        "source": "sentinel-1",
        "sensor_type": "sar",
        "display_name": "Sentinel-1 GRD 2023-12-09 (descending)",
        "data_mode": "fixture",
        "image_path": None,
        "asset_url": None,
        "image_kind": "footprint-only",
        ...
        "caveats": [
            "weak-signal cueing layer; not high-confidence proof",
            "in-between coverage record (between Umbra primary and follow-up)",
        ],
        "missing_asset_reason": (
            "no committed Sentinel-1 GRD raster; footprint-only"
        ),
        "collection_time": "2023-12-09",
        "default_visible": False,
        "resolution_m": 10.0,
        "cloud_coverage": None,
        "weak_signal": True,
    ...
    {
        "overlay_id": "whitsun-sentinel-2-low-cloud-20231214",
        "scenario_id": "whitsun",
        "observation_id": "fixture-s2-l2a-whitsun-20231214-low-cloud",
        "source": "sentinel-2",
        "sensor_type": "optical",
        "display_name": "Sentinel-2 L2A 2023-12-14 (15% cloud)",
        "data_mode": "fixture",
        "image_path": None,
        "asset_url": None,
        "image_kind": "footprint-only",
        ...
        "caveats": [
            "weak-signal cueing layer; not high-confidence proof",
            "low cloud Sentinel-2; useful for tasking cues, not definitive",
            "in-between coverage record (post-follow-up)",
        ],
        "missing_asset_reason": (
            "no committed Sentinel-2 RGB preview; footprint-only"
        ),
        "collection_time": "2023-12-14",
        "default_visible": False,
        "resolution_m": None,
        "cloud_coverage": 15,
        "weak_signal": True,
