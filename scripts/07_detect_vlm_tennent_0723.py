"""Second Tennent VLM run: 2023-07-23 for temporal comparison against 2023-07-02.

Same AOI geometry, same backend, same pipeline config as
``05_detect_vlm_tennent.py``.  Auto-approval gate checks that the scene
metadata matches the expected Tennent Reef AOI before spending.

Outputs (uncommitted pending review):
    data/processed/vlm_detections/tennent_20230723_position.parquet
    day0/scratch/tennent_20230723_vlm_progress.jsonl
    day0/scratch/tennent_20230723_vlm_summary.json
    day0/scratch/tennent_20230723_vlm_detections.png
"""
...
GEC_PATH = SCENE_DIR / "2023-07-23-14-02-49_UMBRA-05_GEC.tif"
META_PATH = SCENE_DIR / "2023-07-23-14-02-49_UMBRA-05_METADATA.json"
...
GATE_TILE_COUNT = (100, 150)
GATE_EST_COST = (1.0, 3.0)
...
PARQUET_PATH = OUT_DIR / "tennent_20230723_position.parquet"
PROGRESS_LOG = SCRATCH / "tennent_20230723_vlm_progress.jsonl"
SUMMARY_JSON = SCRATCH / "tennent_20230723_vlm_summary.json"
PREVIEW_PNG = SCRATCH / "tennent_20230723_vlm_detections.png"
...
def main() -> None:
    ...
    try:
        observations = detect_vessels_in_scene(
            ...
            source_id="umbra-2023-07-23-vlm",
            backend=backend,
